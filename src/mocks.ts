...
export const pokemonListResponseMock2: PokemonListResponse = {
  count: 2,
  next: null,
  previous: null,
  results: [
    { name: "charmander", url: "sample-url" },
    { name: "pickachu", url: "sample-url" },
  ],
}

export const pokemonListResponseMock1: PokemonListResponse = {
  count: 2,
  next: null,
  previous: null,
  results: [
...
export const pokemonMock: PokemonInfo = {
  abilities: [
    {
      ability: {
        name: "limber",
